            ...
            <div class="section" id="feature-product-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        ...
                        <li>
                            <a href="{{route('product.detail', $product->id)}}" title="{{$product->title}}" class="thumb">
                                <img src="{{url($product->thumbnail)}}">
                            </a>
                            <a href="{{route('product.detail', $product->id)}}" title="{{$product->title}}" class="product-name">{{$product->title}}</a>
                            <div class="price">
                                <span class="new">{{number_format($product->price)}}</span>
                                <span class="old">{{!empty($product->discount) ? number_format($product->discount) : ''}}</span>
                            </div>
                            <div class="action clearfix">
                            <a href="{{route('cart.add', $product->id)}}" title="" class="add-cart fl-left" data-max="{{$product->quantity}}" data-id={{$product->id}}><i class="fa fa-spinner fa-spin"></i>Thêm giỏ hàng</a>
                                <a href="{{route('cart.pre_checkout')}}" title="" class="buy-now fl-right">Mua ngay</a>
                            </div>
                        </li>
                        @endforeach
                    </ul>
