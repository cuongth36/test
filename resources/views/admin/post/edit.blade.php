        ...
        <form method="POST" action="{{route('post.update', $post->id)}}" enctype="multipart/form-data">
            @csrf
                <div class="form-group custom-title">
                    ...
                    <input class="form-control change-title" type="text" name="title" id="name" value="{{$post->title}}">
                ...
                <div class="form-group custom-slug">
                    ...
                    <input class="form-control change-slug" type="text" name="slug" id="slug" value="{{$post->slug}}">
                    @error('slug')
                        <small class="text-danger">{{$message}}</small>
                    @enderror
                </div>
