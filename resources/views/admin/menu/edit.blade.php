    ...
    <div class="card">
        ...
        <form method="POST" action="{{route('menu.update',$menus->id)}}" class="action-menu">
            @csrf
                ...
                <input class="form-control change-title" type="text" name="title" id="name" value="{{$menus->title}}">
                    @error('title')
                ...
                <div class="form-group custom-slug">
                    ...
                    <input class="form-control change-slug" type="text" name="slug" id="slug" value="{{$menus->slug}}">
                    @error('slug')
                        <small class="text-danger">{{$message}}</small>
                    @enderror
                </div>
